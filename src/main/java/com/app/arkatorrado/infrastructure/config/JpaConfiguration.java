...
@EnableJpaRepositories(
    basePackages = "com.app.arkatorrado.infrastructure.adapter.out.persistence.repository"
)
@EntityScan(basePackages = "com.app.arkatorrado.infrastructure.adapter.out.persistence.entity")
