package com.skillnest.arkagestorsolicitudes.cli;


import com.skillnest.arkagestorsolicitudes.application.service.CalculoEnvioService;
...
public class CircuitBreakerCLI implements CommandLineRunner {
    ...
    private void mostrarResultadoPrueba(CalculoEnvio resultado, String escenario) {
        ...
        System.out.println("\n🎯 Análisis:");
        if (resultado.getEstado() == com.skillnest.arkagestorsolicitudes.domain.model.EstadoCalculo.FALLBACK) {
